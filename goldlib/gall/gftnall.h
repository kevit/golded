...
//  MA 02111-1307, USA
//  ------------------------------------------------------------------
//  $Id: gftnall.h,v 1.3 2009/04/04 09:51:04 grsf Exp $
//  ------------------------------------------------------------------
...
inline bool ftn_addr::operator==(const ftn_addr& b) const { return equals(b); }
inline bool ftn_addr::operator!=(const ftn_addr& b) const { return !equals(b); }
...
public:
  ...
  ftn_akamatch& operator=(const ftn_akamatch& o) { mask=o.mask; aka=o.aka; return *this; }
