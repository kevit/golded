...
int UUEXPORT
UUSetMsgCallback (void *opaque, void (*func) (void *, char *, int))
{
  uu_MsgCallback = func;
  uu_MsgCBArg    = opaque;
...
int UUEXPORT
UUSetBusyCallback (void *opaque, int (*func)(void *, uuprogress *), long msecs)
{
...
int UUEXPORT
UUSetFileCallback (void *opaque, int (*func)(void *, char *, char *, int))
{
...
int UUEXPORT
UUSetFNameFilter (void *opaque, char * (*func)(void *, char *))
{
  uu_FNameFilter = func;
  uu_FFCBArg     = opaque;
...
int UUEXPORT
UUInfoFile (uulist *thefile, void *opaque, int (*func)(void *, char *))
{
